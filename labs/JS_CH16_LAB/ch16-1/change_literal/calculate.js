...
$(document).ready( () => {
    $("#calculate").click( () => {
        ...
        if (isNaN(cents) || cents < 0 || cents > 99) {
            ...
            let centsM = Object.create(coins);
            centsM.makechange(cents);
            console.log(centsM);

            $("#quarters").val( centsM.quarters );
            $("#dimes").val( centsM.dimes );
            $("#nickels").val( centsM.nickels );
            $("#pennies").val( centsM.pennies );
